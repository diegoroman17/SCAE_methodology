...
def test_SCAE(
             ...
             path_results='/home/dcabrera/Dropbox/Seville/data/results7/',
    ...
    scae = cPickle.load(open(path_results+model))
...
if __name__ == '__main__':
    #test_SCAE(dataset='/home/diego/Dropbox/Seville/data/hgbdcr_TF_ALL.pkl.gz')
